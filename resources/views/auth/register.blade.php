...
@section('content')
    ...
    <form method="POST" action="{{ route('register') }}" class="au-form">
        ...
        <div>
            <label for="apartment_unit_number" class="au-label">{{ __('Unit Number') }}</label>
            <input id="apartment_unit_number" type="text" name="apartment_unit_number"
                   value="{{ old('apartment_unit_number') }}" autocomplete="off" placeholder="e.g., A-1203"
        ...
        <!-- Confirm Password -->
        <div>
            <label for="password_confirmation" class="au-label">{{ __('Confirm Password') }}</label>
            <div class="au-pw">
        ...
        <!-- Submit -->
        <button type="submit" class="au-btn">{{ __('Register') }}</button>
    </form>

    <p class="au-foot">
        <a class="au-link" href="{{ route('login') }}">{{ __('Already registered?') }}</a>
    </p>
