    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <form method="POST" action="{{ route('admin.laundry-pricings.store') }}" class="space-y-4">
                ...
                <div>
                    <x-input-label for="type" :value="__('Jenis Layanan') <span class=\"text-red-500\">*</span>" />
                ...
                <div>
                    <x-input-label for="duration" :value="__('Durasi Pengerjaan') <span class=\"text-red-500\">*</span>" />
                ...
                <div>
                    <x-input-label for="price_per_kg" :value="__('Harga per Kilogram') <span class=\"text-red-500\">*</span>" />
