...
<div class="px-4 pt-4 pb-6 space-y-5 bg-gray-50 min-h-screen">
    ...
    <div>
        ...
        <div class="grid grid-cols-4 gap-3">
            <a href="{{ route('guest.service-requests.create') }}" class="service-item flex flex-col items-center gap-1.5">
            ...
            <a href="{{ route('guest.balance') }}" class="service-item flex flex-col items-center gap-1.5">
                <div class="service-icon flex items-center justify-center">
                    <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
